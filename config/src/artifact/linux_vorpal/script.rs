...
pub fn generate(
    bash_source: &ArtifactId,
    binutils_source: &ArtifactId,
    coreutils_source: &ArtifactId,
    diffutils_source: &ArtifactId,
    file_source: &ArtifactId,
    findutils_source: &ArtifactId,
    gawk_source: &ArtifactId,
    gcc_source: &ArtifactId,
    glibc_source: &ArtifactId,
    grep_source: &ArtifactId,
    gzip_source: &ArtifactId,
    linux_headers_source: &ArtifactId,
    m4_source: &ArtifactId,
    make_source: &ArtifactId,
    ncurses_source: &ArtifactId,
    patch_source: &ArtifactId,
    sed_source: &ArtifactId,
    tar_source: &ArtifactId,
    xz_source: &ArtifactId,
) -> String {
    formatdoc! {"
        set +h
        umask 022
        ...
        bash = step_env_artifact(&bash_source),
        binutils = step_env_artifact(&binutils_source),
        coreutils = step_env_artifact(&coreutils_source),
        diffutils = step_env_artifact(&diffutils_source),
        file = step_env_artifact(&file_source),
        findutils = step_env_artifact(&findutils_source),
        gawk = step_env_artifact(&gawk_source),
        gcc = step_env_artifact(&gcc_source),
        glibc = step_env_artifact(&glibc_source),
        grep = step_env_artifact(&grep_source),
        gzip = step_env_artifact(&gzip_source),
        linux_headers = step_env_artifact(&linux_headers_source),
        m4 = step_env_artifact(&m4_source),
        make = step_env_artifact(&make_source),
        ncurses = step_env_artifact(&ncurses_source),
        patch = step_env_artifact(&patch_source),
        sed = step_env_artifact(&sed_source),
        tar = step_env_artifact(&tar_source),
        xz = step_env_artifact(&xz_source),
    }
}
