...
vorpal:
	cargo $(CARGO_FLAGS) run --bin "vorpal" -- build --agent "https://localhost:23152" --namespace "$(VORPAL_NAMESPACE)" --registry "https://localhost:23152" --worker "https://localhost:23152" $(VORPAL_FLAGS) $(VORPAL_ARTIFACT)
