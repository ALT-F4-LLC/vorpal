...
const (
	...
	ArtifactService_GetArtifactFunctions_FullMethodName = "/vorpal.artifact.ArtifactService/GetArtifactFunctions"
	ArtifactService_GetArtifactFunction_FullMethodName  = "/vorpal.artifact.ArtifactService/GetArtifactFunction"
...
type ArtifactServiceClient interface {
	...
	GetArtifactFunctions(ctx context.Context, in *ArtifactFunctionsRequest, opts ...grpc.CallOption) (*ArtifactFunctionsResponse, error)
	GetArtifactFunction(ctx context.Context, in *ArtifactFunctionRequest, opts ...grpc.CallOption) (*Artifact, error)
...
func (c *artifactServiceClient) GetArtifactFunctions(ctx context.Context, in *ArtifactFunctionsRequest, opts ...grpc.CallOption) (*ArtifactFunctionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ArtifactFunctionsResponse)
	err := c.cc.Invoke(ctx, ArtifactService_GetArtifactFunctions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artifactServiceClient) GetArtifactFunction(ctx context.Context, in *ArtifactFunctionRequest, opts ...grpc.CallOption) (*Artifact, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Artifact)
	err := c.cc.Invoke(ctx, ArtifactService_GetArtifactFunction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArtifactServiceServer interface {
	...
	GetArtifactFunctions(context.Context, *ArtifactFunctionsRequest) (*ArtifactFunctionsResponse, error)
	GetArtifactFunction(context.Context, *ArtifactFunctionRequest) (*Artifact, error)
...
func (UnimplementedArtifactServiceServer) GetArtifactFunctions(context.Context, *ArtifactFunctionsRequest) (*ArtifactFunctionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetArtifactFunctions not implemented")
}
func (UnimplementedArtifactServiceServer) GetArtifactFunction(context.Context, *ArtifactFunctionRequest) (*Artifact, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetArtifactFunction not implemented")
}
...
func _ArtifactService_GetArtifactFunctions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArtifactFunctionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArtifactServiceServer).GetArtifactFunctions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArtifactService_GetArtifactFunctions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArtifactServiceServer).GetArtifactFunctions(ctx, req.(*ArtifactFunctionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ArtifactService_GetArtifactFunction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArtifactFunctionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArtifactServiceServer).GetArtifactFunction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArtifactService_GetArtifactFunction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArtifactServiceServer).GetArtifactFunction(ctx, req.(*ArtifactFunctionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArtifactService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetArtifactFunctions",
			Handler:    _ArtifactService_GetArtifactFunctions_Handler,
		},
		{
			MethodName: "GetArtifactFunction",
			Handler:    _ArtifactService_GetArtifactFunction_Handler,
		},
		{
