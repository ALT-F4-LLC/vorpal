...
func linuxVorpalSetup(binutilsVersion string, gawkVersion string, gccVersion string, glibcVersion string, gmpVersion string, mpcVersion string, mpfrVersion string, ncursesVersion string) string {
