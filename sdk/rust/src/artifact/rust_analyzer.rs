...
/// Build-target `rust-analyzer` component of the Rust toolchain.
#[derive(Default)]
pub struct RustAnalyzer {}

impl RustAnalyzer {
    /// Creates a new `rust-analyzer` builder.
    #[must_use]
    pub fn new() -> Self {
        Self::default()
    }

    /// Builds the `rust-analyzer` artifact for the context's target system.
    ///
    /// # Errors
    ///
