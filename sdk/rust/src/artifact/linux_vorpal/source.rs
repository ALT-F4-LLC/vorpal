...
pub fn curl(version: &str, _digest: &str) -> ArtifactSource {
    let name = "curl";
...
pub fn curl_cacert(_digest: &str) -> ArtifactSource {
...
pub fn file(version: &str, _digest: &str) -> ArtifactSource {
    let name = "file";
...
pub fn gnu(name: &str, version: &str, _digest: &str) -> ArtifactSource {
    let path = format!("https://ftpmirror.gnu.org/gnu/{name}/{name}-{version}.tar.gz");

    ArtifactSourceBuilder::new(name, path.as_str()).build()
}

pub fn gnu_xz(name: &str, version: &str, _digest: &str) -> ArtifactSource {
    let path = format!("https://ftpmirror.gnu.org/gnu/{name}/{name}-{version}.tar.xz");

    ArtifactSourceBuilder::new(name, path.as_str()).build()
}

pub fn gnu_gcc(version: &str, _digest: &str) -> ArtifactSource {
    let name = "gcc";
...
pub fn gnu_glibc_patch(version: &str, _digest: &str) -> ArtifactSource {
...
pub fn libidn2(version: &str, _digest: &str) -> ArtifactSource {
    let name = "libidn2";
...
pub fn libpsl(version: &str, _digest: &str) -> ArtifactSource {
    let name = "libpsl";
    let path = format!(
...
pub fn linux(version: &str, _digest: &str) -> ArtifactSource {
    let name = "linux";
...
pub fn ncurses(version: &str, _digest: &str) -> ArtifactSource {
    let name = "ncurses";
...
pub fn openssl(version: &str, _digest: &str) -> ArtifactSource {
    let name = "openssl";
...
pub fn perl(version: &str, _digest: &str) -> ArtifactSource {
    let name = "perl";
...
pub fn python(version: &str, _digest: &str) -> ArtifactSource {
    let name = "python";
...
pub fn unzip_patch_fixes(version: &str, _digest: &str) -> ArtifactSource {
...
pub fn unzip_patch_gcc14(version: &str, _digest: &str) -> ArtifactSource {
...
pub fn util_linux(version: &str, _digest: &str) -> ArtifactSource {
    let name = "util-linux";
    let path = format!(
...
pub fn xz(version: &str, _digest: &str) -> ArtifactSource {
    let name = "xz";
    let path = format!(
...
pub fn zlib(version: &str, _digest: &str) -> ArtifactSource {
    let name = "zlib";
