...
def stage_02(bash_version: str, binutils_version: str, coreutils_version: str, diffutils_version: str, file_version: str, findutils_version: str, gawk_version: str, gcc_version: str, grep_version: str, gzip_version: str, m4_version: str, make_version: str, ncurses_version: str, patch_version: str, sed_version: str, tar_version: str, xz_version: str) -> str:
    return rf"""set +h
umask 022
...
../configure --prefix="/usr" --host="$VORPAL_TARGET" --build="$($VORPAL_SOURCE/tar/tar-{tar_version}/build-aux/config.guess)"
