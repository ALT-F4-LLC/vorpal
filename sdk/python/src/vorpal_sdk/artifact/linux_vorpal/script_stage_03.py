...
def stage_03(bison_version: str, gettext_version: str, perl_version: str, python_version: str, texinfo_version: str, util_linux_version: str) -> str:
    return rf"""## Setup paths
