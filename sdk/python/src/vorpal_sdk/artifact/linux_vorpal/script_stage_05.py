...
def stage_05(curl_cacert_version: str, curl_version: str, libidn2_version: str, libpsl_version: str, libunistring_version: str, unzip_version: str) -> str:
    return rf"""## Setup environment
...
pushd $VORPAL_SOURCE/unzip/unzip{unzip_version.replace(".", "")}
