...
def setup(binutils_version: str, gawk_version: str, gcc_version: str, glibc_version: str, gmp_version: str, mpc_version: str, mpfr_version: str, ncurses_version: str) -> str:
    return rf"""set +h
umask 022
