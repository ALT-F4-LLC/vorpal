"""rust-std artifact (prebuilt from static.rust-lang.org).

Mirrors ``sdk/typescript/src/artifact/rust_std.js``.
"""
...
class RustStd:
    """Builder for the rust-std artifact."""
    ...
    def build(self, context: ConfigContext) -> str:
        ...
        step_script = (
            ...
            f'{source_target}/{name}-{source_target}/." "$VORPAL_OUTPUT"'
        )
