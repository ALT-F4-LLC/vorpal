...
export function stage01(binutilsVersion: string, gccVersion: string, glibcVersion: string, linuxVersion: string): string {
  return `set +h
umask 022
...
mkdir -p \$VORPAL_SOURCE/binutils-pass-01/binutils-${binutilsVersion}/build
pushd \$VORPAL_SOURCE/binutils-pass-01/binutils-${binutilsVersion}/build
...
pushd \$VORPAL_SOURCE/linux/linux-${linuxVersion}
...
rm -rf \$VORPAL_SOURCE/linux/linux-${linuxVersion}

### Build glibc-pass-01

mkdir -p \$VORPAL_SOURCE/glibc-pass-01/glibc-${glibcVersion}/build
pushd \$VORPAL_SOURCE/glibc-pass-01/glibc-${glibcVersion}/build
...
mkdir -p \$VORPAL_SOURCE/libstdc++/gcc-${gccVersion}/build
pushd \$VORPAL_SOURCE/libstdc++/gcc-${gccVersion}/build
