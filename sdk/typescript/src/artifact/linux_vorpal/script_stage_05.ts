...
export function stage05(curlCacertVersion: string, curlVersion: string, libidn2Version: string, libpslVersion: string, libunistringVersion: string, unzipVersion: string): string {
...
cp -p \$VORPAL_SOURCE/curl-cacert/cacert-${curlCacertVersion}.pem /etc/ssl/certs/ca-certificates.crt
