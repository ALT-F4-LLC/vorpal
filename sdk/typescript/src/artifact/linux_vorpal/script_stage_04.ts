...
export function stage04(binutilsVersion: string, gccVersion: string, glibcVersion: string, opensslVersion: string, zlibVersion: string): string {
  return `## Setup paths
...
mkdir -p \$VORPAL_SOURCE/glibc-pass-02/glibc-${glibcVersion}/build
pushd \$VORPAL_SOURCE/glibc-pass-02/glibc-${glibcVersion}/build
...
mkdir -p \$VORPAL_SOURCE/zlib/zlib-${zlibVersion}/build
pushd \$VORPAL_SOURCE/zlib/zlib-${zlibVersion}/build
...
mkdir -p \$VORPAL_SOURCE/binutils-pass-03/binutils-${binutilsVersion}/build
pushd \$VORPAL_SOURCE/binutils-pass-03/binutils-${binutilsVersion}/build
...
mkdir -p \$VORPAL_SOURCE/gcc-pass-03/gcc-${gccVersion}/build
pushd \$VORPAL_SOURCE/gcc-pass-03/gcc-${gccVersion}/build
...
mkdir -p \$VORPAL_SOURCE/openssl/openssl-${opensslVersion}/build
pushd \$VORPAL_SOURCE/openssl/openssl-${opensslVersion}/build
