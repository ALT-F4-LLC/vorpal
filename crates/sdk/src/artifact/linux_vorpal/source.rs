...
pub fn curl(version: &str, digest: &str) -> ArtifactSource {
    ...
    ArtifactSourceBuilder::new(name, path.as_str())
        .with_digest(digest)
        .build()
}

pub fn curl_cacert(digest: &str) -> ArtifactSource {
    let name = "curl-cacert";
    let path = "https://curl.se/ca/cacert.pem";

    ArtifactSourceBuilder::new(name, path)
        .with_digest(digest)
        .build()
}

pub fn file(version: &str, digest: &str) -> ArtifactSource {
    let name = "file";
...
pub fn gnu(name: &str, version: &str, digest: &str) -> ArtifactSource {
...
pub fn gnu_xz(name: &str, version: &str, digest: &str) -> ArtifactSource {
...
pub fn gnu_gcc(version: &str, digest: &str) -> ArtifactSource {
    let name = "gcc";
...
pub fn gnu_glibc_patch(version: &str, digest: &str) -> ArtifactSource {
...
pub fn libidn2(version: &str, digest: &str) -> ArtifactSource {
    let name = "libidn2";
...
pub fn libpsl(version: &str, digest: &str) -> ArtifactSource {
    let name = "libpsl";
    let path = format!(
...
pub fn linux(version: &str, digest: &str) -> ArtifactSource {
    let name = "linux";
...
pub fn ncurses(version: &str, digest: &str) -> ArtifactSource {
    let name = "ncurses";
...
pub fn openssl(version: &str, digest: &str) -> ArtifactSource {
    let name = "openssl";
...
pub fn perl(version: &str, digest: &str) -> ArtifactSource {
    let name = "perl";
...
pub fn python(version: &str, digest: &str) -> ArtifactSource {
    let name = "python";
...
pub fn unzip_patch_fixes(version: &str, digest: &str) -> ArtifactSource {
...
pub fn unzip_patch_gcc14(version: &str, digest: &str) -> ArtifactSource {
...
pub fn unzip(version: &str, digest: &str) -> ArtifactSource {
    let name = "unzip";
...
pub fn util_linux(version: &str, digest: &str) -> ArtifactSource {
    let name = "util-linux";
    let path = format!(
...
pub fn xz(version: &str, digest: &str) -> ArtifactSource {
    let name = "xz";
    let path = format!(
...
pub fn zlib(version: &str, digest: &str) -> ArtifactSource {
    let name = "zlib";
