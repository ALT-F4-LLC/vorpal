...
NIX_CONFIG_BINARIES="environment\.systemPackages = \[pkgs\.automake pkgs\.autoconf pkgs\.bubblewrap pkgs\.gcc pkgs\.git\ pkgs\.gnumake pkgs\.help2man pkgs\.patchelf pkgs\.perl pkgs\.rsync pkgs\.vim];"
